var store = [{
        ...
        "excerpt":"Read this to have the context. NiagaraDataChannels could be used not only to efficently spawn explosions, footsteps and dusts, but also for… numbers. There is more then 230000 sprite particles of different numbers with different colors and length. The question, why do we need so much??? Idk 😂 A bit...","categories": [],
        "tags": [],
